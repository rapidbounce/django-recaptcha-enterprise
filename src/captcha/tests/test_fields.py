...
class TestWidgets(TestCase):
    ...
    def test_default_v2_checkbox_html(self, mocked_uuid):
        ...
        html = form.as_p()
        self.assertIn(
            '<script src="https://www.google.com/recaptcha/enterprise.js' '"></script>', html
        )
    ...
    def test_v2_checkbox_attribute_changes_html(self, mocked_uuid):
        ...
        html = form.as_p()
        self.assertIn(
            '<script src="https://www.google.com/recaptcha/enterprise.js' '?hl=af"></script>',
            html,
        )
    ...
    def test_v2_invisible_attribute_changes_html(self, mocked_uuid):
        ...
        html = form.as_p()
        self.assertIn(
            '<script src="https://www.google.com/recaptcha/enterprise.js' '?hl=cl"></script>',
            html,
        )
